...
export const zh = {
  ...
  'message.stopped': '已停止',
  'message.longReply.folded': '长回复已折叠',
  'message.longReply.expand': '展开全文',
  'message.longReply.truncated': '（预览已截断，共 {total} 字符）',
...
export const en = {
  ...
  'message.longReply.folded': 'Long reply folded',
  'message.longReply.expand': 'Expand full reply',
  'message.longReply.truncated': '(preview truncated, {total} characters total)',
