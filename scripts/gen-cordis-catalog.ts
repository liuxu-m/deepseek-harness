...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  SubagentControlRequestId: 'subagent.md',
  SubagentControlResult: 'subagent.md',
  SubagentQueueOptions: 'subagent.md',
  SubagentSteerOptions: 'subagent.md',
  SubagentCloseAuthority: 'subagent.md',
  SubagentCloseOptions: 'subagent.md',
  SubagentCloseResult: 'subagent.md',
  SubagentStatusSnapshot: 'subagent.md',
