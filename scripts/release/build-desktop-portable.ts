...
const DESKTOP_PACKAGE = '@deepseek-ai/dsh-desktop-tauri'
...
const DEFAULT_EXE = 'apps/desktop-tauri/src-tauri/target/release/deepseek-harness-desktop.exe'
...
async function assembleStage(input: {
  ...
  await copyFile(join(input.root, 'apps/desktop-tauri/README.txt'), join(input.stage, 'README.txt'))
