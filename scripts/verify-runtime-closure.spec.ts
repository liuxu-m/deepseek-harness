...
`,
  ...
  it('resolves apps workspace dependencies for a Desktop deployment manifest', async () => {
    const root = fixture({
      'apps/desktop/package.json': { name: '@scope/desktop', dependencies: { '@scope/web': 'workspace:^' } },
